    ...
    .get(function (req, res, next) {
        var insertQuery = '\
            ...
            let transporter = nodemailer.createTransport({
              ...
              port: 587,
              auth: {
                user: "ecommerceapputbm@gmail.com",
                pass: "EmdzUnFWqTCthp1Q"
              },
              tls: {
            ...
            let mailOptions = {
              from: "ecommerceapputbm@gmail.com",
              to: "kaoutarderouach02@gmail.com",
              subject: "Confirmation email",
              text: "This is a confirmation email"+" Sub Total "+
              req.session.cartSummary.subTotal + ', ' +" discount "+
              req.session.cartSummary.discount + ', ' +" shipCost  "+
              req.session.cartSummary.shipCost + ', ' +"  Total "+
              req.session.cartSummary.total + ', NOW(), \'Order Received\');'
            };
